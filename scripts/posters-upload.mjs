// ═══════════════════════════════════════════════════════════════════════════════
// POSTERS FINESI · upload de PDFs locales → R2 + tabla documents (category="posters")
//
// Uso: node scripts/posters-upload.mjs
// Lee: researchfinesi/Poster FINESI/*.pdf
// ═══════════════════════════════════════════════════════════════════════════════
...
const LOCAL_FOLDER = String.raw`C:\Users\USUARIO\Desktop\researchfinesi\Poster FINESI`;
const CATEGORY = "posters";
const R2_FOLDER = "posters";
...
// Parsear el título: quitar prefijo "N " del ordenamiento en disco
// Ej: "1 RR 1919-2023-R-UNA Hugo Ticona" → "RR 1919-2023-R-UNA Hugo Ticona"
...
async function main() {
  ...
  console.log(`\n▸ Posters FINESI — ${files.length} PDFs`);
  console.log(`  ${LOCAL_FOLDER}`);

  // Idempotente: skip títulos ya existentes en category="posters"
