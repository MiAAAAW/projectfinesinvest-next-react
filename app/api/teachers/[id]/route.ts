  ...
  try {
    ...
    const teacher = await prisma.teacher.update({
      ...
      data: {
        ...
        ...(data.researchGate !== undefined && { researchGate: data.researchGate }),
        ...(data.personalWebsite !== undefined && { personalWebsite: data.personalWebsite }),
        ...(data.ctiVitaeUrl !== undefined && { ctiVitaeUrl: data.ctiVitaeUrl }),
        ...(data.bio !== undefined && { bio: data.bio }),
        ...(data.hindex !== undefined && { hindex: data.hindex }),
