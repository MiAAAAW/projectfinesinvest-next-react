...
// ═══════════════════════════════════════════════════════════════════════════════
// RESOLUCIONES RECTORALES LIST PAGE
// Lista de resoluciones rectorales con filtros y acciones
// ═══════════════════════════════════════════════════════════════════════════════
...
export default function ResolucionesRectoralesPage() {
  const {
    items: resolutions,
    loading,
    searchQuery,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Resoluciones Rectorales</h1>
          <p className="text-muted-foreground">
            Gestiona las resoluciones rectorales de la universidad
          </p>
        </div>
        <Button asChild>
          <Link href="/admin/resolutions/rectorales/new">
      ...
      <PageHeaderEditor
        section="resoluciones-rectorales"
        placeholderTitle="Resoluciones Rectorales"
        placeholderDescription="Resoluciones emitidas por el Rectorado de la UNA Puno."
      />
              ...
              {loading ? (
                ...
                <TableRow>
                  <TableCell colSpan={6} className="h-24 text-center">
                    No se encontraron resoluciones rectorales
                  </TableCell>
                </TableRow>
              ) : (
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem asChild>
                            <Link href={`/admin/resolutions/rectorales/${resolution.id}`}>
